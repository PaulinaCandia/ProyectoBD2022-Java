...
CREATE TABLE aportes_solicitados (
    id_aport_soli     NUMBER(5) NOT NULL,
...
COMMENT ON COLUMN aportes_solicitados.id_cupon IS
...
ALTER TABLE aportes_solicitados ADD CONSTRAINT id_aportes_solicitados_pk PRIMARY KEY ( id_aport_soli );
...
CREATE TABLE estado_de_cuentas (
    id_estado_cuenta    NUMBER(20) NOT NULL,
...
COMMENT ON COLUMN socios.fecha_inscripcion IS
    'fecha en la que se inscribi� el socio,  [default = sysdate]';
...
ALTER TABLE aportes_solicitados
    ADD CONSTRAINT aportes_fk FOREIGN KEY ( aportes_id_aporte )
        REFERENCES aportes ( id_aporte );

ALTER TABLE creditos_solicitados
    ADD CONSTRAINT creditos_fk FOREIGN KEY ( id_credito )
...
ALTER TABLE aportes_solicitados
    ADD CONSTRAINT cupones_de_pagos_fk FOREIGN KEY ( id_cupon )
...
ALTER TABLE creditos_solicitados
    ADD CONSTRAINT socios_fk FOREIGN KEY ( id_socio )
        REFERENCES socios ( id_socio );

ALTER TABLE aportes_solicitados
    ADD CONSTRAINT socios_fkv2 FOREIGN KEY ( id_socio )
        REFERENCES socios ( id_socio );
